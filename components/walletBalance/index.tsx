...
const Index = (props) => {
    ...
    const instructions: React.ReactChild =
        <List>
            ...
            <Row>If this is your first time buying ETH, please read our ETH Buying Guide by clicking here:
                <Link href="#">  ...ETH Buying Guide...</Link></Row>
    ...
    return (
        <Card title='Buy STRIPCOIN.' functional={functional} instructions={instructions} isMobile={props.isMobile}/>
    );
};
