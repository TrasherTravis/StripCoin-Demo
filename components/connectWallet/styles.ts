...
export const WalletDisconnect: React.FC<any> = styled.p`
  color: #7900bf;
  cursor: pointer;
...
export const Separator: React.FC<any> = styled.div`
  width: 5px;
  border-left: 1px solid #FFF;
`;

export const ButtonDisconnect: React.FC<any> = styled.div`
  display: flex;
  flex-direction: row;
`;

export const ContainerConnect: React.FC<any> = styled.div`
  display: flex;
  width: 100%;
  margin: 1em 0 0 1em;
